...
8. **No Advice**: Do NOT recommend treatments or next steps.
9. **Prefer Silence**: If a value is ambiguous, output "UNKNOWN" rather than guessing.
10. **JSON Only**: Output pure JSON.
